export default {
  ...
  game: {
    ...
    blockBuildHint: 'Build the correct sequence from the blocks below',
    blockBuildSaveHint: 'Your progress is saved when you leave this platform',
    blockBuildYour: 'Your answer',
    blockBuildPool: 'Available blocks',
    blockBuildDropHere: 'Drag blocks here',
    blockBuildPoolEmpty: 'All blocks are in use',
    blockBuildRemove: 'Remove from sequence',
    submit: 'Submit',
