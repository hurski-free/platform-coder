export default {
  ...
  game: {
    ...
    blockBuildHint: 'Соберите верную последовательность из блоков ниже',
    blockBuildSaveHint: 'Прогресс сохраняется при переходе на другую платформу',
    blockBuildYour: 'Ваша ответ',
    blockBuildPool: 'Доступные блоки',
    blockBuildDropHere: 'Перетащите блоки сюда',
    blockBuildPoolEmpty: 'Все блоки использованы',
    blockBuildRemove: 'Убрать из последовательности',
    submit: 'Ответить',
